            ...
            <div class="row marzeros">
                <div class="col-sm-7">
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="radio" id="option1" name="money" value="Rent" v-on:change="type1"> 
                            <label class="radiolabel marcustradio" for="option1"><span><span></span></span>Rent</label>
                            <input type="radio" id="option2" name="money" value="RentDeposit" v-on:change="type2">
                            <label class="radiolabel marcustradio" for="option2"><span><span></span></span>Rent Deposit</label>
                            <input type="radio" id="option3" name="money" value="Maintenance" v-on:change="type3">
                    ...
                    <div class="col-sm-12"  style="max-width: 340px;">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" id="sel1" v-model.trim="transaction.month">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" id="sel1" v-model.trim="transaction.year">
                        ...
                        <div class="row marzeros">
                            ...
                            <input type="text" class="form-control" v-model.trim="transaction.rent_amount" placeholder="Monthly rent" v-on:change="pan_need">
                            </div>
                        ...
                        <div v-show="pan_doc_need==1" >
                         ...
                         <div class="row marzeros">
                           ...
                           <textarea class="form-control" v-model.trim="transaction.remarks" rows="2" id="comment"></textarea>
                            </div>
                        </div>
                ...
                <div class="col-sm-5">
                    ...
                    <div class="text-center" style="margin: 0px 15px;">
                        <button type="submit" class="btn btn-info" style="width:100%;background:#0071bc;border-color:#0071bc;color:#ffffff;">Make Payment</button>
                    </div>
                </div>
              </div>
            </div>
