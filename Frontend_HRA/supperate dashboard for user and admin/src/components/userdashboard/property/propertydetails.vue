      ...
      <div class="row marzeros">
        <div class="row marzeros">
          ...
          <div class="col-sm-3">
            ...
            <p class="fon14 clrliteash"><button type="button" class="btn btn-info mar5_5 blubtn" data-toggle="modal" data-target="#datareceipt">{{property.Landlord_PAN_number}}</button>&nbsp;&nbsp;<span><i class="far fa-file-image" style="color:#3284EF;"></i></span></p>
          </div>
          <div class="modal fade" id="datareceipt" role="dialog">
            <div class="modal-dialog modal-lg"
              <pdf src='"http://localhost:8000/Pandocs/oJZZdMZlxc5cSick.pdf"'></pdf>
            </div>
          </div>
        </div>
        <div class="row marzeros">
    ...
    <div class="row marzeros">
      ...
      <div class="row marzeros">
        <div class="row marzeros">
          ...
          <div class="col-sm-3">
              <p class="fon14 clrliteash"><button type="button" class="btn btn-info mar5_5 blubtn" data-toggle="modal" data-target="#datareceipt1">{{property.rent_agreement_name}}</button>&nbsp;&nbsp;<span><i class="far fa-file-image" style="color:#3284EF;"></i></span></p>
            </div>
            <div class="modal fade" id="datareceipt1" role="dialog">
              <div class="modal-dialog modal-lg"
                <img :src='"http://localhost:8000/Propertydocuments/"+"property.rent_agreement_name"'>
              </div>
            </div>
        </div>
      </div>
  ...
  data(){
    return {
      ...
      mounted(){
        ...
        let self=this;
        axios.get("http://127.0.0.1:8000/api/getproperty/"+localstore.details.property_id)
        ...
        axios.get('http://127.0.0.1:8000/api/getlandlord/'+localstore.details.property_id)
              .then(function (response) {
                if(response.data.data){
                console.log(response.data.data);
              ...
              .catch((error) => alert(error));
          axios.get('http://127.0.0.1:8000/api/getdocuments/'+localstore.details.landlord_id+'/'+localstore.details.property_id)
                .then(function (response) {
                  if(response.data.data){
                  console.log(response.data.data),
