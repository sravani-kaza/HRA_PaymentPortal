        ...
        <div class="row marzero0">
            <div class="col-sm-12">
                <div class="form-group custrespformgrop">
                        ...
                        <p>
                          <input data-vv-validate-on="blur" name="startdate agreement" type="date" v-model.trim="agreement.startdate_agreement" v-validate="'required|date_format:DD/MM/YYYY'" class="form-control step_3" ref="startdate">
        ...
        <div class="row marzero0">
            <div class="col-sm-12">
                <div class="form-group custrespformgrop">
                        ...
                        <p>
                          <input data-vv-validate-on="blur" name="enddate agreement" type="date" v-model.trim="agreement.enddate_agreement" v-validate="'required|date_format:DD/MM/YYYY|after:startdate'" class="form-control step_3" >
