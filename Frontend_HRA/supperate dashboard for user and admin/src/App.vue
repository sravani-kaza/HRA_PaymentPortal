...
<script>
import dashboard from '@/components/userdashboard/dashboard/dashboard.vue';
import admin_dashboard from '@/components/admindashboard/dashboard/dashboard'
import form_main from '@/components/userdashboard/mainform/form_main.vue';
...
.off-canvas-sidebar {
  ...
  .off-canvas-sidebar[data-active-color="danger"] .nav li.active > a {
    color: #EB5E28;
    opacity: 1; }
    .sidebar[data-active-color="customblue"] .nav li.active > a,
  .off-canvas-sidebar[data-active-color="customblue"] .nav li.active > a {
    color: #3284EF;
    opacity: 1; }
...
.main-panel {
  ...
  box-shadow: inset -1px 3px 23px -1px rgba(57, 55, 73, 0.46);}
