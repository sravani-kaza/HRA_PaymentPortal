...
<div class="mainfomlayout">
    <div class="row" style="margin-top:10px;font-family: 'Roboto', sans-serif;">
        ...
        <div class="col-sm-6">
            <div class="form-group custrespformgrop">
                    <label class="lblcustm"> Password(min 6 characters)</label>
                    <input type="password" name="pwd" class="form-control" minlength=6 >
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group custrespformgrop">
                    <label class="lblcustm">Retype Password</label>
                    <input type="password" name="retpwd" class="form-control" >
            </div>
        </div>
        <div class="row marzero0">
            <div class="col-sm-6">
        ...
        <div class="row marzero0">
            <div class="col-sm-6">
                <div class="form-group custrespformgrop">
                        <label class="lblcustm" >User City</label>
                        <input type="text" class="form-control" >
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group custrespformgrop">
                        <label class="lblcustm" >User state</label>
                        <input type="text" class="form-control" >
                    </div>
            </div>
        </div>
        <div class="row marzero0" style="margin-bottom:20px;">
            ...
            <router-link :to="{ name: 'home' }"><div class="col-xs-6"><button type="button" class="btn btn-info custbtnn">Save and Next</button></div></router-link>
            </div>
        </div>
    </div>
    </div>
